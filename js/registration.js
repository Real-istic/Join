...
function loadRegistrationPageBackgroundAndLogo() {
    return /*html*/`
        <div class="registration-container" id="registrationContainer">
            <svg class="join-logo-login" viewBox="0 0 47 58" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//übergang:Log-in
//-Hintergrund: blau->weiß  class = registration-container id = registrationContainer background-color: #4589ff; (<-blau)
//-Logo: weiß-blau class = join-logo-login-color
//-Logo: opacity class = join-logo-login
//-Logo: position class = join-logo-login
//-Log-in-window:display  class = log-in-input-container
//-Upper right content: display class = registration-upper-right-inner-container